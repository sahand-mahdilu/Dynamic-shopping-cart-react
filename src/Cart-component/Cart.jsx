export default function Cart({
  ...
  return (
    <div className="Cart_container max-w-56 bg-gray-200 rounded-xl ">
      <h1 className="title text-center pb-1 text-gray-800 text-lg font-semibold">
        Product Cart
      </h1>
      ...
      <div className="cart flex flex-col items-center justify-center">
        ...
        <button className="bg-blue-600 text-white p-2 w-full mt-8 hover:bg-blue-400">
          Add to Cart
        </button>
      </div>
    </div>
